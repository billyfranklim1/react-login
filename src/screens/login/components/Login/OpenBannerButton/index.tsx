...
function CloseBannerButton() {
  ...
  return (
    <div className="absolute left-5 hidden lg:block md:block">
      <button
        className="mt-5 w-10 h-10 bg-blue-500 text-white rounded-full hover:bg-blue-700 flex items-center justify-center dark:bg-neutral-800 dark:text-white dark:bg-blue-500 dark:hover:bg-blue-700"
